...
def date_fashion(eu, par):
    ...
    if eu >= 8 or par >= 8:
        ...
        return 1
#mesmo não tendo namorada, funcionou
...
def squirrel_play(temp, is_summer):
    if is_summer == False and 59 < temp < 91:
        return True
    if is_summer == True and 59 < temp < 101:
        return True
    else:
        return False
...
def pego_correndo(speed, is_birthday):
    if speed <= 60 or speed <=65 and is_birthday == True:
        return 0
    if 61 <= speed <= 80 or 66 <= speed <= 85 and is_birthday == True:
        return 1
    if speed > 80 or speed > 85 and is_birthday == True:
        return 2
